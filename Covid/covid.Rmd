...
This analysis draws on nationally representative survey data to examine fluctuations in self-reported anxiety and depression symptoms over the course of the pandemic, using a combination of flexible regression and multivariate statistical modeling.
...
Mental health issues surged globally during the COVID-19 pandemic, exacerbated by lockdowns, social isolation, economic instability, and public health uncertainty. Measuring and modeling these effects is critical to planning equitable health interventions and understanding long-term community resilience. This study analyzes national data to uncover temporal and demographic trends in reported anxiety and depression. Our goal is to use robust statistical techniques to better understand the human cost of the pandemic and inform future intervention strategies.
