...
### We modeled the national estimate of mental health symptoms over time using both linear (GLM) and non-linear (GAM) models.
...
- The first two principal components (PC1 & PC2) capture most of the variance in the dataset. Based on your scree plot and PC loadings:
